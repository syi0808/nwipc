...
initial bundle load, direct `IOSurface` binary echo with a signed native peer, and forced
`WebContent` process replacement. Unsupported OS/build combinations fail closed at the SPI probe
